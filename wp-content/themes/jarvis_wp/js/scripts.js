	...
	jQuery(window).on("scroll", function(){
		...
		var home_height =  jQuery('.home-parallax').outerHeight();
			...
			if (jQuery(window).scrollTop() > home_height-headerH-1){
				jQuery('nav.transparent').addClass('scroll');		
				jQuery('#kj_logo').attr('src','https://eatwildsalmon.com/wp-content/uploads/2016/03/Kwee-black-transparent.png');								
			} else {
				jQuery('nav.transparent').removeClass('scroll');
				jQuery('#kj_logo').attr('src','https://eatwildsalmon.com/wp-content/uploads/2016/02/Kwee-white-transparent-nav.png');									
			}
